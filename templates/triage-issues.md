...
4. **Identify up to 3 cross-cutting patterns** across the triaged items
   (if fewer than 3 patterns exist, state how many were found and why):
...
- [ ] Patterns section identifies up to 3 cross-cutting patterns
